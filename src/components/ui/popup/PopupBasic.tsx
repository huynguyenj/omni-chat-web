...
export default function PopupBasic({ onClose, title, children }: PopupProps) {
  return (
    <div className="min-h-screen max-w-screen absolute inset-0 backdrop-blur-none bg-black/50 flex items-center justify-center z-9999">
      <motion.div
        initial = {{ scale: 0, opacity: 0 }}
        animate = {{ scale: 1, opacity: 1 }}
        exit={{ scale: 0, opacity: 0 }}
        className="min-w-[35%] max-h-[90vh] bg-white px-5 py-5 rounded-xl relative overflow-y-auto">
