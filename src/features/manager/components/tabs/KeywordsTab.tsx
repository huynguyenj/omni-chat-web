                  ...
                  {keyWordList.items.map((keyword) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-2">
                        <Button variant="outline" className="flex-9 text-black border-border-primary py-1 hover:bg-gray-200" onClick={() => handleOpenEdit(keyword)}>
                          <Edit2 className="size-4" />
                          Sửa
                        </Button>
                        <Button variant="outline" className="py-2 px-3 text-red-500 hover:text-red-500 border-border-primary hover:bg-gray-200" onClick={() => handleOpenAlert(keyword.id)}
                        >
