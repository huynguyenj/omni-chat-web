...
// const fakeData: Recommendation[] =
//   [
//     {
//       recommendType:'SearchOrderHistory',
//       data: {
//         orderId: '9e2d6f51-1e52-4c9c-8b2f-0e93a9c7f1aa',
//         orderCode: 'ORD001',
//         totalAmount: 1500000,
//         orderName: 'Đơn hàng laptop',
//         orderStatus: 'Success',
...
//     },
//     {
//       recommendType: 'SearchProduct',
//       data: {
//         productId: '0c7d3b6e-9f2a-4d5f-b5c7-3f7c2b2e1a77',
//         productName: 'Laptop Dell XPS 13',
//         productCode: 'DX13',
//         productImageUrl: 'https://cdn.example.com/products/dx13.png'
//       }
//     },
//     {
//       recommendType: 'SearchCustomerInfo',
//       data: {
//         customerName: 'Nguyen Van A',
...
function ProductButton({ productData }: { productData: ProductType}) {
  ...
  return (
    <>
      <Button variant='outline' className='rounded-2xl py-2 border border-blue-200 hover:bg-secondary hover:text-white hover:border-none gap-2' onClick={handleOpen}>
...
//       return <CustomerProfileButton customerData={recommend.data} />
  ...
  return (
    <div className="py-2 px-3 bg-linear-to-r from-blue-100 to-[#F9F5FF] border border-blue-200 rounded-lg mb-2 min-w-90">
