    ...
    <Card variant='default' className='py-4 px-5 my-5 border-2 border-border-primary text-sm-body-desktop'>
      ...
      <div className='mt-10'>
        ...
        <div className='flex justify-between mt-3'>
          ...
          <p className='font-medium'>{capacityProduct}ml</p>
        </div>
        ...
        <div className='flex justify-between mt-3'>
          ...
          <p className='font-medium'>{totalBatch} sản phẩm</p>
        </div>
        ...
        <div className='flex justify-between font-medium mt-3'>
          ...
          <p className='text-green-accent font-medium'>{totalPrice ? totalPrice.toLocaleString('vi-VN') : 0}đ</p>
        </div>
      </div>
    </Card>
  )
