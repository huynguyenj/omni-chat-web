                ...
                <div>
                  { checked ?
                    <SelectionBox
                      ...
                      <div className='flex gap-2 bg-amber-300 w-full'>
                        <Input label='Số lượng muốn mua' variant='gray' type='number' onChange={(e) => setNumberOfProduct(Number(e.target.value))} className='w-[50%]'/>
