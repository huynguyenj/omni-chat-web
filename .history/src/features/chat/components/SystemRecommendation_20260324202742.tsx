...
function OrderButton() {
  ...
  const [selectedProduct, setProduct] = useState<ProductListType>()
              ...
              <div className='mt-7'>
                ...
                <ScrollArea className='h-60'>
                  { filterProductList.map((product) => (
                    <Card key={product.productId} className={`border-2 border-border-primary px-5 py-3 my-3 ${product.productId === product.productId}`} onClick={() => handleSelectProduct(product.productId)}>
