          ...
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            <div className='flex gap-2 items-center'>
              ...
              <div className={`text-soft-gray flex items-center gap-2 ${index === 2 && 'text-secondary'}`}>
                <div className={`flex items-center justify-center bg-gray-200 font-medium rounded-full w-8 h-8  ${index === 2 && 'text-white bg-secondary'}`}>1</div>
                <p className={`text-sm-body-desktop ${index === 2 && 'font-medium text-secondary'}`}>Chọn Lôô</p>
              </div>
              <hr className='border-2 border-border-primary w-13'/>
              <div className={`text-soft-gray flex items-center gap-2 ${index === 3 && 'text-secondary'}`}>
                <div className={`flex items-center justify-center bg-gray-200 font-medium rounded-full w-8 h-8  ${index === 3 && 'text-white bg-secondary'}`}>1</div>
                <p className={`text-sm-body-desktop ${index === 3 && 'font-medium text-secondary'}`}>Chọn SP</p>
              </div>
            </div>
            { index == 1 &&
            <div id='index#1'>
