                    ...
                    <SelectionBox
                      ...
                      <div className='flex gap-2 items-center w-full'>
                        <div className='flex-1'>
                          <Input label='Số lượng muốn mua' variant='gray' placeholder='1' type='number' onChange={(e) => setNumberOfProduct(Number(e.target.value))} className='text-center text-black shadow-[0px_2px_1px_1px_rgba(0,0,0,0.1)]'/>
                        </div>
                        <div className='flex-2 bg-amber-500 my-auto'>
                          <p className='text-sm-body-desktop text-soft-gray'>/ <span className='text-primary font-medium'>{batchChosen.storage}</span> còn lại</p>
                        </div>
                      </div>
