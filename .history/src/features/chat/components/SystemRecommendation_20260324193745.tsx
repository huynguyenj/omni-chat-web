              ...
              <div className='mt-7'>
                ...
                <ScrollArea className='h-60'>
                  { filterProductList.map((product) => (
                    <Card key={product.productId} className='border-3 border-border-primary px-5 py-3 my-3'>
                      ...
                      <div className='flex gap-3'>
                        <p className='text-sm-body-desktop text-green-accent font-bo'>{product.price.toLocaleString('vi-VN')}</p>
