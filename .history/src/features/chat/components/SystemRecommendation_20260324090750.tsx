...
const listProducts: ProductListType[] = [
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'not', price: 32000, productId: 'VNAIN', storage: 286 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'have', price: 33000, productId: 'VNAIH', storage: 220 },
  { name: 'Vinamilk', capacity: [180, 490], category: 'sour', price: 30000, productId: 'VNAS', storage: 168 },
  { name: 'TH True Milk', capacity: [180, 490, 880, 1760], category: 'not', price: 35000, productId: 'THTMN', storage: 286 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'not', price: 32000, productId: 'VNAI', storage: 286 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'not', price: 32000, productId: 'VNAI', storage: 286 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'not', price: 32000, productId: 'VNAI', storage: 286 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'not', price: 32000, productId: 'VNAI', storage: 286 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'not', price: 32000, productId: 'VNAI', storage: 286 }
...
function OrderButton() {
  ...
  const [typeProduct, setTypeProduct] = useState<{ type: 'sour' | 'have' | 'not' }>({ type: 'not' })
  const [capacityProduct, setCapacityProduct] = useState<{ capacity: 180 | 490 | 880 | 1760 }>({ capacity: 180 })
