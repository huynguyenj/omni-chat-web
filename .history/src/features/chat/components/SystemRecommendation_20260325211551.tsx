            ...
            <div id='index#2'>
              <div className='mt-7'>
                ...
                <Card className='bg-[#EFF6FF] border-secondary rounded-md'>
                  ...
                  <p className='text-sm-body-desktop text-primary font-medium text-sm/6'>{selectedProduct?.name}</p>
                  <div className='flex gap-3'>
                    ...
                    <Tag className='bg-transparent px-2 py-1 text-secondary font-medium border-secondary'>
