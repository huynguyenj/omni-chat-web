        ...
        {isOpen &&
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            <div className='flex gap-2 items-center'>
              <div className={`text-soft-gray flex items-center gap-2 bg-amber-200 p-3 ${index === 1 && 'text-secondary'}`}>
                <div className={`flex items-center justify-center bg-gray-200 font-medium rounded-full w-10 h-10  ${index === 1 && 'text-white bg-secondary'}`}>1</div> 
                <p>Chọn SP</p>
              </div>
              <hr className='border-2 border-border-primary w-13'/>
              <div className={`bg-gray-200 text-soft-gray ${index === 2 && 'text-secondary'}`}>
                <span className={`bg-gray-200 font-medium rounded-full p-2 ${index === 2 && 'text-white bg-secondary'}`}>2</span> Chọn Lô
              </div>
              <hr className='border-2 border-border-primary w-13'/>
              <div className={`bg-gray-200 text-soft-gray ${index === 3 && 'text-secondary'}`}>
                <span className={`bg-gray-200 font-medium rounded-full p-2 ${index === 3 && 'text-white bg-secondary'}`}>3</span> Xác nhận
              </div>
            </div>
