...
function OrderButton() {
  ...
  return (
    <>
      ...
      <div>
        <div className={`bg-gray-200 text-soft-gray ${processIndex === 0 && 'text-secondary'}`}>
          <span className={`bg-gray-200 font-medium rounded-full p-2 ${processIndex === 0 && 'text-white bg-secondary'}`}>1</span> Chọn SP
        </div>
        <div className={`bg-gray-200 text-soft-gray ${processIndex === 1 && 'text-secondary'}`}>
          <span className={`bg-gray-200 font-medium rounded-full p-2 ${processIndex === 1 && 'text-white bg-secondary'}`}>1</span> Chọn Lô
        </div>
        <div className={`bg-gray-200 text-soft-gray ${processIndex === 2 && 'text-secondary'}`}>
          <span className={`bg-gray-200 font-medium rounded-full p-2 ${processIndex === 2 && 'text-white bg-secondary'}`}>1</span> Xác nhậnnhận
        </div>
      </div>
      <AnimatePresence>
        {isOpen &&
