...
const listProducts: ProductListType[] = [
  ...
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'have', price: 33000, productId: 'VNAIS', storage: 220 },
  { name: 'Vinamilk', capacity: [180, 490, 880, 1760], category: 'sour', price: 32000, productId: 'VNAI', storage: 286 },
