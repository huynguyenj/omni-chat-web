...
const listProducts: ProductListType[] = [
  ...
  // Dalat Milk (3)
  { name: 'Dalat Milk', capacity: [180, 490, 880, 1760], category: 'not', price: 31000, productId: 'DLM-N-01', storage: 210, company: '' },
  { name: 'Dalat Milk', capacity: [180, 490, 880], category: 'have', price: 32000, productId: 'DLM-H-02', storage: 184, company: '' },
  { name: 'Dalat Milk', capacity: [180, 490], category: 'sour', price: 29500, productId: 'DLM-S-03', storage: 153, company: '' }
