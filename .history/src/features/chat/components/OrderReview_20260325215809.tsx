...
export default function OrderReview({ batch, batchDate, capacityProduct, productName, totalPrice, totalProduct, typeProduct, company }: Partial<OrderReviewType>) {
  return (
    <Card variant='default' className='py-4 px-5 my-5 border-2 border-border-primary text-sm-body-desktop'>
      ...
      <div className='mt-10'>
        ...
        <div className='flex items-center gap-2 py-3 px-3 bg-[#EFF6FF] rounded-xl'>
