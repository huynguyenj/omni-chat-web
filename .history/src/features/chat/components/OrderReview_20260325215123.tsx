...
export default function OrderReview({ batch, batchDate, capacityProduct, productName, shipDate, totalPrice, totalProduct, typeProduct }: Partial<OrderReviewType>) {
  return (
    <Card variant='default' className='py-4 px-5 my-5 border-2 border-border-primary text-sm-body-desktop'>
      <p className='text-sm-body-desktop text-primary font-medium'>Thông tin đơn hàng</p>
      <div className='mt-10'>
