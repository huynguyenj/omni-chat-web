          ...
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            ...
            <div id='index#2'>
              <div className='mt-7'>
                ...
                <Card className='bg-[#EFF6FF] border-secondary rounded-md'>
                  <p>Sản phẩm đã chọn</p>
                  <p>{selectedProduct?.name}</p>
                  <div className='flex gap-3'>
                    <Tag className={`bg-transparent px-2 py-1 border ${typeProduct?.type === 'sour' ? ' border-[#C27AFF] text-[#9810FA]'
                    ...
                    <Tag className='bg-transparent px-2 py-1 text-secondary font-medium border='>
                      {capacityProduct?.capacity}ml
                    </Tag>
                    <p className='text-sm-body-desktop text-soft-gray'>Tồn kho: <span className='font-medium text-secondary'>{selectedProduct?.storage}</span></p>
                  </div>
                </Card>
                <div className='flex items-center gap-2 my-4 bg-[#F5F7FA] py-3 px-2 rounded-md'>
                  ...
                  <div>
                    ...
                    <p className='text-[0.85rem] text-soft-gray font-medium'>Hệ thống sẽ tự động chọn lô có hạn sử dụng xa nhất</p>
                  </div>
                </div>
                <div>
                  { checked ?
                    <SelectionBox
                      ...
                      <div className='w-full flex flex-col'>
                        <div className='w-full flex items-center justify-between'>
                          <div className='flex items-center gap-2'>
                            ...
                            <Tag variant='primary' className='py-0.5 px-3'>Mới nhất</Tag>
                          </div>
                      ...
                      <div className='flex gap-2 items-center jus w-full'>
                        <Input label='Số lượng muốn mua' variant='gray' placeholder='1' type='number' onChange={(e) => setNumberOfProduct(Number(e.target.value))} className='w-[20%] text-center text-black shadow-[0px_2px_1px_1px_rgba(0,0,0,0.1)]'/>
                        <p className='text-sm-body-desktop text-soft-gray bg-amber-200 w-full'>/ <span className='text-primary font-medium'>{batchChosen.storage}</span> còn lại</p>
                      </div>
