                  ...
                  { checked ?
                    <SelectionBox
                      ...
                      <div className='flex gap-2  w-full'>
                        <Input label='Số lượng muốn mua' variant='gray' placeholder='1' type='number' onChange={(e) => setNumberOfProduct(Number(e.target.value))} className='w-[50%] text-center text-black'/>
