        ...
        {isOpen &&
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            <div className='flex gap-2 items-center'>
              <div className={`text-soft-gray flex items-center gap-2 h-fit bg-amber-200 p-3 ${index === 1 && 'text-secondary'}`}>
                <div className={`bg-gray-200 font-medium rounded-full p-2 ${index === 1 && 'text-white bg-secondary'}`}>1</div> 
                <p>Chọn SP</p>
              </div>
