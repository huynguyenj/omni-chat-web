                ...
                <div>
                  { checked ?
                    <SelectionBox
                      ...
                      <Input label='Số lượng muốn mua' variant='gray' placeholder='1' type='number' onChange={(e) => setNumberOfProduct(Number(e.target.value))} className='w-[20%] text-center text-black shadow-[0px_2px_1px_1px_rgba(0,0,0,0.1)] mt-'/>
                    </SelectionBox>
                    :
                    <>
