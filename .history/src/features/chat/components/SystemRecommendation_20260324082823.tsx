        ...
        {isOpen &&
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            <div className='flex gap-2 items-center'>
              <div className={`text-soft-gray h-fit bg-amber-200 p-3 ${index === 1 && 'text-secondary'}`}>
                <span className={`bg-gray-200 font-medium rounded-full px-2 py-1 ${index === 1 && 'text-white bg-secondary'}`}>1</span> Chọn SP
              </div>
              <hr className='border-2 border-border-primary w-20'/>
