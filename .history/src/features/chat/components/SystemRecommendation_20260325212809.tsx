              ...
              <div className='mt-7'>
                ...
                <Card className='bg-[#EFF6FF] border-2 border-[#C9D9F5] rounded-xl my-5'>
                  ...
                  <div className='flex items-center gap-3'>
                    <Tag className={`bg-transparent rounded-2xl px-2 py-0.5 border ${typeProduct?.type === 'sour' ? ' border-[#C27AFF] text-[#9810FA]'
                    ...
                    <Tag className='bg-transparent rounded-2xl px-2 py-0.5 text-secondary font-medium border-secondary'>
                    ...
                    <SelectionBox
                      ...
                      <div className='w-full flex flex-col mb-3'>
                        <div className='w-full flex gap-3'>
                          ...
                          <div className='flex justify-between items-st w-full'>
