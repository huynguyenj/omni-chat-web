      ...
      <AnimatePresence>
        {isOpen &&
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            ...
            <div id='index#2'>
              <div className='mt-7'>
                <TutorialBox step='Bước 2: Chọn lô hàng & Số lượnglượng' description='Chọn lô hàng và nhập số lượng mong muốnmuốn'/>
                <div className='flex items-center gap-2 my-4 bg-gray-100 py-2 px-3 rounded-sm'>
