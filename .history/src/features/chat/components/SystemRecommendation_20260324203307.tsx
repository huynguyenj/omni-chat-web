...
const listProducts: ProductListType[] = [
  ...
  // TH True Milk (3)
  { name: 'TH True Milk', capacity: [180, 490, 880, 1760], category: 'not', price: 35000, productId: 'THM-N-01', storage: 195, company: 'T' },
  { name: 'TH True Milk', capacity: [180, 490, 880], category: 'have', price: 36000, productId: 'THM-H-02', storage: 174, company: 'T' },
  { name: 'TH True Milk', capacity: [180, 490], category: 'sour', price: 34000, productId: 'THM-S-03', storage: 142, company: 'T' },
        ...
        {isOpen &&
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            ...
            <div id='index#1'>
              <div className='mt-7'>
                ...
                <ScrollArea className='h-60'>
                  { filterProductList.map((product) => (
                    <Card key={product.productId} className={`border-2 border-border-primary px-5 py-3 my-3 ${product.productId === selectedProduct?.productId && 'border-secondary bg-[#DBEAFE]'}`} onClick={() => handleSelectProduct(product.productId)}>
                      ...
                      <div>
                        ...
                        { selectedProduct && <IoMdCheckmarkCircleOutline className='size-5 text-secondary'/> }
                      </div>
              ...
              <Button className={`w-full font-bold mt-5 ${!selectedProduct && 'opacity-50'}`} onClick={handleNext} disabled={selectedProduct ? true : false}>
                  Tiếp theo
                <IoIosArrowForward/>
              </Button>
            </div>
