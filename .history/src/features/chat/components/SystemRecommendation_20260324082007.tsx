...
const listBatches: BatchesType[] = [
  ...
  { batchId: 'LOTe20260118', date: '18/03/2026', storage: 71 }
]

function OrderButton() {
  const [procIndex, setProccessIndex] = useState(0)
  const [isOpen, setIsOpen] = useState(false)
  ...
  return (
    <>
      ...
      <div>
        <div className={`bg-gray-200 text-soft-gray ${proccesIndex ===}`}><span className={`font-medium rounded-full p-2`}>1</span> Chọn SP</div>
        <div><span>2</span> Chọn Lô</div>
