                      ...
                      { listBatches.map((batch) => (
                        <SelectionBox
                          ...
                          <div className='flex flex-col w-full'>
                            ...
                            <>
                              <hr className='border-2 border-border-primary my-2 w-full'/>
                              <Input label='Số lượng muốn mua' variant='gray' placeholder='0' type='number' onChange={(e) => set(Number(e.target.value))} className='w-[20%] text-center text-black shadow-[0px_2px_1px_1px_rgba(0,0,0,0.1)]'/>
                            </>
                            }
                          </div>
                        </SelectionBox>
