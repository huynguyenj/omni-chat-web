          ...
          <PopupBasic title='Tạo đơn hàng mới' onClose={handleOpen}>
            ...
            <div id='index#2'>
                      ...
                      { listBatches.map((batch) => (
                        <SelectionBox
                          ...
                          <div className='flex flex-col w-full'>
                            ...
                            <>
                              <hr className='border-2 border-border-primary my-2 w-full'/>
                              <Input label='Số lượng muốn mua' variant='gray' placeholder='0' type='number' onChange={(e) => setNumberOfProduct(Number(e.target.value))} className='w-[20%] text-center text-black shadow-[0px_2px_1px_1px_rgba(0,0,0,0.1)]'/>
                            </>
                            }
                          </div>
                        </SelectionBox>
              ...
              <div className='flex gap-2 mt-3'>
                ...
                <Button className={`w-full font-bold ${!selectedProduct && 'opacity-50'}``} onClick={handleNext} disabled={batchChosen ? false : true}>
                  Tiếp theo
                  <IoIosArrowForward/>
                </Button>
              </div>
